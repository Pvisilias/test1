...
import {
  require_en,
  styles_default
} from "/build/_shared/chunk-ODDTLQ4E.js";
import {
  require_node
...
var require_web_api = __commonJS({
  "node_modules/@shopify/shopify-api/adapters/web-api/index.js"(exports) {
    ...
    (0, runtime_1.setAbstractFetchFunc)(fetch);
...
var require_version = __commonJS({
  "node_modules/@shopify/shopify-api/lib/version.js"(exports) {
    ...
    exports.SHOPIFY_API_LIBRARY_VERSION = "9.2.0";
  }
});
...
var CLIENT, MIN_RETRIES, MAX_RETRIES, GQL_API_ERROR, UNEXPECTED_CONTENT_TYPE_ERROR, NO_DATA_OR_ERRORS_ERROR, CONTENT_TYPES, RETRY_WAIT_TIME, RETRIABLE_STATUS_CODES;
...
function validateDomainAndGetStoreUrl({ client, storeDomain }) {
  try {
    ...
    const protocolUrl = trimmedDomain.startsWith("http") ? trimmedDomain : `https://${trimmedDomain}`;
...
var DEFAULT_CONTENT_TYPE, DEFAULT_CLIENT_VERSION, ACCESS_TOKEN_HEADER, CLIENT2, RETRIABLE_STATUS_CODES2, DEFAULT_RETRY_WAIT_TIME;
var init_constants2 = __esm({
  "node_modules/@shopify/admin-api-client/dist/constants.mjs"() {
    DEFAULT_CONTENT_TYPE = "application/json";
    DEFAULT_CLIENT_VERSION = "0.2.3";
...
function createAdminApiClient({ storeDomain, apiVersion, accessToken, userAgentPrefix, retries = 0, customFetchApi, logger }) {
  ...
  const config = {
    ...
    headers: {
      ...
      "User-Agent": `${userAgentPrefix ? `${userAgentPrefix} | ` : ""}${CLIENT2} v${DEFAULT_CLIENT_VERSION}`
    },
...
function createAdminRestApiClient({ storeDomain, apiVersion, accessToken, userAgentPrefix, logger, customFetchApi = fetch, retries: clientRetries = 0, scheme = "https", defaultRetryTime = DEFAULT_RETRY_WAIT_TIME, formatPaths = true }) {
  ...
  const request = async (path, { method, data, headers: requestHeadersObj, searchParams, retries = 0, apiVersion: apiVersion2 }) => {
    ...
    const userAgent = [
      ...
      `${CLIENT2} v${DEFAULT_CLIENT_VERSION}`
    ].join(" | ");
    ...
    function throwFailedRequest(body, response, atMaxRetries) {
      ...
      if (response.status === network_1.StatusCode.Ok && body.errors.graphQLErrors) {
        throw new ShopifyErrors.GraphqlQueryError({
          message: (_c3 = (_b = body.errors.graphQLErrors) === null || _b === void 0 ? void 0 : _b[0].message) !== null && _c3 !== void 0 ? _c3 : "GraphQL operation failed",
          response,
...
var CLIENT3, MIN_RETRIES2, MAX_RETRIES2, GQL_API_ERROR2, UNEXPECTED_CONTENT_TYPE_ERROR2, NO_DATA_OR_ERRORS_ERROR2, CONTENT_TYPES2, RETRY_WAIT_TIME2, RETRIABLE_STATUS_CODES3;
var init_constants3 = __esm({
  "node_modules/@shopify/storefront-api-client/dist/graphql-client/dist/graphql-client/constants.mjs"() {
    CLIENT3 = "GraphQL Client";
    MIN_RETRIES2 = 0;
    MAX_RETRIES2 = 3;
    GQL_API_ERROR2 = "An error occurred while fetching from the API. Review 'graphQLErrors' for details.";
    UNEXPECTED_CONTENT_TYPE_ERROR2 = "Response returned unexpected Content-Type:";
    NO_DATA_OR_ERRORS_ERROR2 = "An unknown error has occurred. The API did not return a data object or any errors in its response.";
    CONTENT_TYPES2 = {
      json: "application/json",
      multipart: "multipart/mixed"
    };
    RETRY_WAIT_TIME2 = 1e3;
    RETRIABLE_STATUS_CODES3 = [429, 503];
  }
});

// node_modules/@shopify/storefront-api-client/dist/graphql-client/dist/graphql-client/utilities.mjs
function formatErrorMessage2(message2, client = CLIENT3) {
  return message2.startsWith(`${client}`) ? message2 : `${client}: ${message2}`;
}
function getErrorMessage2(error) {
  return error instanceof Error ? error.message : JSON.stringify(error);
}
function validateRetries2({ client, retries }) {
  if (retries !== void 0 && (typeof retries !== "number" || retries < MIN_RETRIES2 || retries > MAX_RETRIES2)) {
    throw new Error(`${client}: The provided "retries" value (${retries}) is invalid - it cannot be less than ${MIN_RETRIES2} or greater than ${MAX_RETRIES2}`);
  }
}
function getKeyValueIfValid2(key, value) {
  return value && (typeof value !== "object" || Array.isArray(value) || typeof value === "object" && Object.keys(value).length > 0) ? { [key]: value } : {};
}
...
function generateHttpFetch2({ clientLogger, customFetchApi = fetch, client = CLIENT3, defaultRetryWaitTime = RETRY_WAIT_TIME2, retriableCodes = RETRIABLE_STATUS_CODES3 }) {
  const httpFetch = async (requestParams, count, maxRetries) => {
    const nextCount = count + 1;
    const maxTries = maxRetries + 1;
    let response;
    try {
      ...
      if (nextCount <= maxTries) {
        const retryAfter = response?.headers.get("Retry-After");
        await sleep2(retryAfter ? parseInt(retryAfter, 10) : defaultRetryWaitTime);
        clientLogger({
          type: "HTTP-Retry",
          content: {
            requestParams,
      ...
      throw new Error(formatErrorMessage2(`${maxRetries > 0 ? `Attempted maximum number of ${maxRetries} network retries. Last message - ` : ""}${getErrorMessage2(error)}`, client));
    }
  };
  return httpFetch;
}
async function sleep2(waitTime) {
  return new Promise((resolve) => setTimeout(resolve, waitTime));
}
var init_http_fetch2 = __esm({
  "node_modules/@shopify/storefront-api-client/dist/graphql-client/dist/graphql-client/http-fetch.mjs"() {
    init_constants3();
    init_utilities3();
  }
...
function createGraphQLClient2({ headers, url, customFetchApi = fetch, retries = 0, logger }) {
  validateRetries2({ client: CLIENT3, retries });
  const config = {
    headers,
    url,
    retries
  };
  const clientLogger = generateClientLogger3(logger);
  const httpFetch = generateHttpFetch2({
    customFetchApi,
    clientLogger,
    defaultRetryWaitTime: RETRY_WAIT_TIME2
  });
  const fetch2 = generateFetch2(httpFetch, config);
  const request = generateRequest2(fetch2);
  return {
    config,
    fetch: fetch2,
    request
...
function generateClientLogger3(logger) {
  return (logContent) => {
    if (logger) {
      logger(logContent);
    }
...
async function processJSONResponse2(response) {
  const { errors, data, extensions } = await response.json();
  return {
    ...getKeyValueIfValid2("data", data),
    ...getKeyValueIfValid2("extensions", extensions),
    ...errors || !data ? {
      errors: {
        networkStatusCode: response.status,
        message: formatErrorMessage2(errors ? GQL_API_ERROR2 : NO_DATA_OR_ERRORS_ERROR2),
        ...getKeyValueIfValid2("graphQLErrors", errors),
        response
      }
    } : {}
  };
}
function generateFetch2(httpFetch, { url, headers, retries }) {
  return async (operation, options = {}) => {
    const { variables, headers: overrideHeaders, url: overrideUrl, retries: overrideRetries } = options;
    const body = JSON.stringify({
      query: operation,
    ...
    validateRetries2({ client: CLIENT3, retries: overrideRetries });
    const flatHeaders = Object.fromEntries(Object.entries({ ...headers, ...overrideHeaders }).map(([key, value]) => [
      key,
      Array.isArray(value) ? value.join(", ") : value.toString()
    ]));
...
function generateRequest2(fetch2) {
  return async (...props) => {
    try {
      const response = await fetch2(...props);
      const { status, statusText } = response;
      ...
      if (!response.ok) {
        return {
          errors: {
            networkStatusCode: status,
            message: formatErrorMessage2(statusText),
            response
          }
        };
      }
      if (!contentType.includes(CONTENT_TYPES2.json)) {
        return {
          errors: {
            networkStatusCode: status,
            message: formatErrorMessage2(`${UNEXPECTED_CONTENT_TYPE_ERROR2} ${contentType}`),
            response
          }
        };
      }
      return processJSONResponse2(response);
    } catch (error) {
      return {
        errors: {
...
var init_graphql_client2 = __esm({
  "node_modules/@shopify/storefront-api-client/dist/graphql-client/dist/graphql-client/graphql-client.mjs"() {
    init_http_fetch2();
    init_constants3();
    init_utilities3();
...
function validateDomainAndGetStoreUrl2({ client, storeDomain }) {
  try {
    if (!storeDomain || typeof storeDomain !== "string") {
      throw new Error();
    }
...
function validateApiVersion2({ client, currentSupportedApiVersions, apiVersion, logger }) {
  const versionError = `${client}: the provided apiVersion ("${apiVersion}")`;
  const supportedVersion = `Currently supported API versions: ${currentSupportedApiVersions.join(", ")}`;
  if (!apiVersion || typeof apiVersion !== "string") {
    throw new Error(`${versionError} is invalid. ${supportedVersion}`);
...
function getQuarterMonth2(quarter) {
  const month = quarter * 3 - 2;
  return month === 10 ? month : `0${month}`;
}
function getPrevousVersion2(year2, quarter, nQuarter) {
  const versionQuarter = quarter - nQuarter;
  if (versionQuarter <= 0) {
    return `${year2 - 1}-${getQuarterMonth2(versionQuarter + 4)}`;
  }
  return `${year2}-${getQuarterMonth2(versionQuarter)}`;
}
function getCurrentApiVersion2() {
  const date = /* @__PURE__ */ new Date();
  const month = date.getUTCMonth();
  const year2 = date.getUTCFullYear();
  const quarter = Math.floor(month / 3 + 1);
  return {
    year: year2,
    quarter,
    version: `${year2}-${getQuarterMonth2(quarter)}`
  };
}
function getCurrentSupportedApiVersions2() {
  const { year: year2, quarter, version: currentVersion } = getCurrentApiVersion2();
  const nextVersion = quarter === 4 ? `${year2 + 1}-01` : `${year2}-${getQuarterMonth2(quarter + 1)}`;
  return [
    getPrevousVersion2(year2, quarter, 3),
    getPrevousVersion2(year2, quarter, 2),
    getPrevousVersion2(year2, quarter, 1),
    currentVersion,
    nextVersion,
    "unstable"
  ];
}
var init_api_versions2 = __esm({
  "node_modules/@shopify/storefront-api-client/dist/graphql-client/dist/api-client-utilities/api-versions.mjs"() {
  }
});

// node_modules/@shopify/storefront-api-client/dist/graphql-client/dist/api-client-utilities/utilities.mjs
function generateGetHeaders2(config) {
  return (customHeaders) => {
    return { ...customHeaders ?? {}, ...config.headers };
  };
}
function generateGetGQLClientParams2({ getHeaders, getApiUrl }) {
  return (operation, options) => {
    const props = [operation];
    if (options && Object.keys(options).length > 0) {
      const { variables, apiVersion: propApiVersion, headers, retries } = options;
...
var DEFAULT_CONTENT_TYPE2, DEFAULT_SDK_VARIANT, DEFAULT_CLIENT_VERSION2, PUBLIC_ACCESS_TOKEN_HEADER, PRIVATE_ACCESS_TOKEN_HEADER, SDK_VARIANT_HEADER, SDK_VERSION_HEADER, SDK_VARIANT_SOURCE_HEADER, CLIENT4;
var init_constants4 = __esm({
  "node_modules/@shopify/storefront-api-client/dist/constants.mjs"() {
    DEFAULT_CONTENT_TYPE2 = "application/json";
    DEFAULT_SDK_VARIANT = "storefront-api-client";
    DEFAULT_CLIENT_VERSION2 = "0.2.3";
...
function validatePrivateAccessTokenUsage(privateAccessToken) {
  if (privateAccessToken && typeof window !== "undefined") {
    throw new Error(`${CLIENT4}: private access tokens and headers should only be used in a server-to-server implementation. Use the public API access token in nonserver environments.`);
  }
}
function validateRequiredAccessTokens(publicAccessToken, privateAccessToken) {
  if (!publicAccessToken && !privateAccessToken) {
    throw new Error(`${CLIENT4}: a public or private access token must be provided`);
  }
  if (publicAccessToken && privateAccessToken) {
    throw new Error(`${CLIENT4}: only provide either a public or private access token`);
  }
}
var init_validations4 = __esm({
  "node_modules/@shopify/storefront-api-client/dist/validations.mjs"() {
    init_constants4();
  }
});
...
function createStorefrontApiClient({ storeDomain, apiVersion, publicAccessToken, privateAccessToken, clientName, retries = 0, customFetchApi, logger }) {
  const currentSupportedApiVersions = getCurrentSupportedApiVersions2();
  const storeUrl = validateDomainAndGetStoreUrl2({
    client: CLIENT4,
    storeDomain
  });
  const baseApiVersionValidationParams = {
  ...
  validateApiVersion2({ ...baseApiVersionValidationParams, apiVersion });
  ...
  const config = {
    ...
    headers: {
      ...
      [SDK_VERSION_HEADER]: DEFAULT_CLIENT_VERSION2,
  ...
  const graphqlClient = createGraphQLClient2({
    headers: config.headers,
    url: config.apiUrl,
    retries,
    customFetchApi,
  ...
  const getHeaders = generateGetHeaders2(config);
  const getApiUrl = generateGetApiUrl2(config, apiUrlFormatter);
  const getGQLClientParams = generateGetGQLClientParams2({
    getHeaders,
    getApiUrl
  });
  const client = {
    ...
    function getExistingHandlers(config, session) {
      ...
      return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        do {
          ...
          endCursor = (_d = (_c3 = response.data) === null || _c3 === void 0 ? void 0 : _c3.webhookSubscriptions) === null || _d === void 0 ? void 0 : _d.pageInfo.endCursor;
          ...
          try {
            ...
            if ((_b = (_a = response.data) === null || _a === void 0 ? void 0 : _a.appSubscriptionCancel) === null || _b === void 0 ? void 0 : _b.userErrors.length) {
              throw new error_1.BillingError({
                ...
                errorData: (_d = (_c3 = response.data) === null || _c3 === void 0 ? void 0 : _c3.appSubscriptionCancel) === null || _d === void 0 ? void 0 : _d.userErrors
              });
            }
...
var require_version3 = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/version.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var SHOPIFY_REMIX_LIBRARY_VERSION = "2.5.0";
    ...
    function registerWebhooksFactory({
      ...
      return async function registerWebhooks({
        ...
        return api.webhooks.register({
          ...
          const graphQLErrors = ((_error$body = error.body) === null || _error$body === void 0 ? void 0 : (_error$body$errors = _error$body.errors) === null || _error$body$errors === void 0 ? void 0 : _error$body$errors.graphQLErrors) || [];
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/billing/check.js
var require_check2 = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/billing/check.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var shopifyApi = require_lib();
    init_esm();
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/helpers/create-admin-api-context.js
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/helpers/redirect-to-shopify-or-app-root.js
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/helpers/ensure-app-is-embedded-if-required.js
var require_ensure_app_is_embedded_if_required = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/helpers/ensure-app-is-embedded-if-required.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var redirectToShopifyOrAppRoot = require_redirect_to_shopify_or_app_root();
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/helpers/redirect-to-bounce-page.js
var require_redirect_to_bounce_page = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/helpers/redirect-to-bounce-page.js"(exports) {
    ...
    var redirectToBouncePage = (params, url) => {
      ...
      throw serverRuntime.redirect(`${config.auth.patchSessionTokenPath}?${searchParams.toString()}`);
    };
    exports.redirectToBouncePage = redirectToBouncePage;
  }
});

// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/helpers/ensure-session-token-search-param-if-required.js
var require_ensure_session_token_search_param_if_required = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/helpers/ensure-session-token-search-param-if-required.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var redirectToBouncePage = require_redirect_to_bounce_page();
    var SESSION_TOKEN_PARAM = "id_token";
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/helpers/validate-shop-and-host-params.js
...
var require_authenticate = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/authenticate.js"(exports) {
    ...
    var check2 = require_check2();
    var createAdminApiContext = require_create_admin_api_context();
    var ensureAppIsEmbeddedIfRequired = require_ensure_app_is_embedded_if_required();
    var ensureSessionTokenSearchParamIfRequired = require_ensure_session_token_search_param_if_required();
    require_lib();
    var redirect = require_redirect();
    var renderAppBridge = require_render_app_bridge();
    var validateShopAndHostParams = require_validate_shop_and_host_params();
    function authStrategyFactory({
      ...
      function createContext(request$1, session, authStrategy, sessionToken) {
        const context = {
          ...
          billing: {
            ...
            check: check2.checkBillingFactory(params, request$1, session),
      ...
      return async function authenticateAdmin(request2) {
        try {
          rejectBotRequest.respondToBotRequest(params, request2);
          respondToOptionsRequest.respondToOptionsRequest(params, request2);
          ...
          if (!getSessionTokenHeader.getSessionTokenHeader(request2)) {
            validateShopAndHostParams.validateShopAndHostParams(params, request2);
            await ensureAppIsEmbeddedIfRequired.ensureAppIsEmbeddedIfRequired(params, request2);
            await ensureSessionTokenSearchParamIfRequired.ensureSessionTokenSearchParamIfRequired(params, request2);
          }
          ...
          if (errorOrResponse instanceof Response) {
            ensureCorsHeaders.ensureCORSHeadersFactory(params, request2)(errorOrResponse);
          }
    ...
    async function getSessionTokenContext(params, request2) {
      ...
      const headerSessionToken = getSessionTokenHeader.getSessionTokenHeader(request2);
      const searchParamSessionToken = getSessionTokenHeader.getSessionTokenFromUrlParam(request2);
  ...
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/webhooks/authenticate.js"(exports) {
    ...
    function authenticateWebhookFactory(params) {
      ...
      return async function authenticate2(request) {
        ...
        if (!check2.valid) {
          if (check2.reason === shopifyApi.WebhookValidationErrorReason.InvalidHmac) {
            logger.debug("Webhook HMAC validation failed", check2);
            throw new Response(void 0, {
              status: 401,
              statusText: "Unauthorized"
            });
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/errors.js
var require_errors = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/errors.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var shopifyApi = require_lib();
    var SessionNotFoundError = class extends shopifyApi.ShopifyError {
    };
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/helpers/trigger-after-auth-hook.js
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/strategies/auth-code-flow.js
var require_auth_code_flow = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/strategies/auth-code-flow.js"(exports) {
    ...
    var redirectWithExitiframe = require_redirect_with_exitiframe();
    var getSessionTokenHeader = require_get_session_token_header();
    var triggerAfterAuthHook = require_trigger_after_auth_hook();
    var validateShopAndHostParams = require_validate_shop_and_host_params();
    require_isbot2();
        ...
        return handleClientError.handleClientErrorFactory({
          ...
          onError: async ({
            ...
            if (error.response.code === 401) {
              throw await redirectToAuthPage.redirectToAuthPage({
                api,
                config,
                logger
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/helpers/respond-to-invalid-session-token.js
var require_respond_to_invalid_session_token = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/helpers/respond-to-invalid-session-token.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var redirectToBouncePage = require_redirect_to_bounce_page();
    var _const = require_const();
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/strategies/token-exchange.js
var require_token_exchange2 = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/admin/strategies/token-exchange.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var shopifyApi = require_lib();
    require_isbot2();
    var respondToInvalidSessionToken = require_respond_to_invalid_session_token();
    init_esm();
    var handleClientError = require_handle_client_error();
    var triggerAfterAuthHook = require_trigger_after_auth_hook();
    var TokenExchangeStrategy = class {
        ...
        if (!session || session.isExpired()) {
          ...
          try {
            await this.handleAfterAuthHook({
              ...
              config,
              logger
            }, newSession, request, sessionToken);
          } catch (error) {
            throw new Response(void 0, {
              status: 500,
              statusText: "Internal Server Error"
      ...
      async exchangeToken({
        ...
        try {
          ...
          var _error$response$body;
          if (error instanceof shopifyApi.InvalidJwtError || error instanceof shopifyApi.HttpResponseError && error.response.code === 400 && ((_error$response$body = error.response.body) === null || _error$response$body === void 0 ? void 0 : _error$response$body.error) === "invalid_subject_token") {
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/helpers/idempotent-promise-handler.js
var require_idempotent_promise_handler = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/helpers/idempotent-promise-handler.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/flow/authenticate.js
var require_authenticate5 = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/authenticate/flow/authenticate.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var factory = require_factory();
    function authenticateFlowFactory(params) {
      ...
      return async function authenticate2(request) {
        ...
        if (!result.valid) {
          logger.error("Received an invalid flow request", {
...
var require_shopify_app = __commonJS({
  "node_modules/@shopify/shopify-app-remix/build/cjs/server/shopify-app.js"(exports) {
    ...
    var authenticate2 = require_authenticate();
    var authenticate$2 = require_authenticate2();
    ...
    var authCodeFlow = require_auth_code_flow();
    var tokenExchange = require_token_exchange2();
    var idempotentPromiseHandler = require_idempotent_promise_handler();
    var authenticate$1 = require_authenticate5();
    function shopifyApp(appConfig) {
      ...
      const authStrategy = authenticate2.authStrategyFactory({
        ...params,
        strategy: config.future.unstable_newEmbeddedAuthStrategy && config.isEmbeddedApp ? new tokenExchange.TokenExchangeStrategy(params) : new authCodeFlow.AuthCodeFlowStrategy(params)
      });
      const shopify = {
        ...
        authenticate: {
          ...
          webhook: authenticate$2.authenticateWebhookFactory(params)
        },
        unauthenticated: {
...
function App() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react2.AppProvider, { isEmbeddedApp: true, apiKey, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("ui-nav-menu", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/app/confiq", children: "Configurations" }, void 0, false, {
        fileName: "app/routes/app.jsx",
        lineNumber: 49,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/app/new", children: "What's New" }, void 0, false, {
        fileName: "app/routes/app.jsx",
        lineNumber: 50,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/app/billing", children: "Plans" }, void 0, false, {
        fileName: "app/routes/app.jsx",
        lineNumber: 51,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/app/guide", children: "Guide" }, void 0, false, {
        fileName: "app/routes/app.jsx",
        lineNumber: 52,
        columnNumber: 9
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/app/support", children: "Support" }, void 0, false, {
        fileName: "app/routes/app.jsx",
        lineNumber: 53,
        columnNumber: 9
      }, this)
...
function ErrorBoundary() {
  ...
  return import_server.boundary.error(error);
}
...
//# sourceMappingURL=/build/routes/app-6OQNU2PL.js.map
